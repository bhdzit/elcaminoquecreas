...
function agregarPersona(token, ruta) {
    Swal.fire({
        ...
        html:
            ...
            token +
            '<p>DATOS DE NACIMIENTO<p>' +
            '<input name="name" required id="swal-input1" class="swal2-input" placeholder="Ingresa Nombre" >' +
            '<div class="justify-content-center"><input required name="date" type="date" id="swal-input1" class="col-5"  >' +
            '<input required name="time" type="time" id="swal-input1" class="col-5"></div>' +
            '<select required name="provincia" class="swal2-input">' +
            '<option>Selecione prvoncia</option>' +

            getPaises +

            '</select>' +
            '<input required  name="ciudad" id="swal-input1" class="swal2-input" placeholder="CIUDAD">' +
...
function getPaises() {
    return '<option value="Afganistán" id="AF">Afganistán</option>' +

    ...
    <section id="home" class="slider_area" style=" background-image: url('./assets/images/bg15.png');">
        <div class="container  mw-100  pt-200">
            ...
            <div class="row justify-content-center mt-5 mr-5 ml-5 mb-5 pb-5">
                ...
                <h3 class="text-center text-white p-0 mb-4 fw-normal">DESDE: 15/04/2020 | HASTA: 07/08/2020</h3>

                <p class="text-center text-white p-0 mb-4"><strong>PARA : </strong></p>
                <h3 class="text-center text-white p-0 mb-4 fw-normal">MARÍA ALEJANDRA ROFRIGUEZ CASTELLÓN</h3>
                ...
                <div class="row justify-content-center mt-4 p-0">
                    <div class="col-12 col-md-4 mb-4">
                        <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined"
                            autocomplete="off">
                        <label class="check-logo" for="danger-outlined">Escribe el pais</label>
                    </div>
                    <div class="col-12 col-md-4 mb-4">
                        <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined"
                            autocomplete="off">
                        <label class="check-logo" for="danger-outlined">Escribe la ciudad</label>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-4 p-0">
                    <div class="col-12 col-md-3">
                        <input class="btn-white-MediumPurple text-center" value="CONTINUAR"
                            onclick="window.location='./previstadeinforme'" type="button">
                    </div>
                </div>

                <div class="row justify-content-center mt-4 p-0">
                    <div class="col-12 col-md-3">
                        <input class="btn-MediumPurple" value="CAMBIAR DATOS"
                            onclick="window.location='./primordial'" type="button">
                    </div>
                </div>
